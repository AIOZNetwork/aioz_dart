module.exports = {
    base: "/aioz_dart/",
    title: "aioz_dart",
    description: "Documentation for the aioz_dart SDK",
    head: [
        ...
        ['meta', {property: "og:title", content: "aioz_dart documentation"}],
        ['meta', {property: "og:description", content: "Learn how to use the aioz_dart SDK"}],
