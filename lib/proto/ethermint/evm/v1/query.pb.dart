...
class QueryTraceTxRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $3.TraceConfig get traceConfig => $_getN(2);
  @$pb.TagNumber(3)
  set traceConfig($3.TraceConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTraceConfig() => $_has(2);
  @$pb.TagNumber(3)
  void clearTraceConfig() => clearField(3);
  @$pb.TagNumber(3)
  $3.TraceConfig ensureTraceConfig() => $_ensure(2);

  @$pb.TagNumber(4)
  $core.List<$0.MsgEthereumTx> get predecessors => $_getList(3);
  ...
  @$pb.TagNumber(7)
  $5.Timestamp get blockTime => $_getN(6);
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(7)
  $5.Timestamp ensureBlockTime() => $_ensure(6);
}
