...
final $typed_data.Uint8List queryCosmosAccountRequestDescriptor = $convert.base64Decode('ChlRdWVyeUNvc21vc0FjY291bnRSZXF1ZXN0EhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3M6COigHwCIoB8A');
...
final $typed_data.Uint8List queryValidatorAccountRequestDescriptor = $convert.base64Decode('ChxRdWVyeVZhbGlkYXRvckFjY291bnRSZXF1ZXN0EiEKDGNvbnNfYWRkcmVzcxgBIAEoCVILY29uc0FkZHJlc3M6COigHwCIoB8A');
...
final $typed_data.Uint8List queryBalanceRequestDescriptor = $convert.base64Decode('ChNRdWVyeUJhbGFuY2VSZXF1ZXN0EhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3M6COigHwCIoB8A');
...
final $typed_data.Uint8List queryStorageRequestDescriptor = $convert.base64Decode('ChNRdWVyeVN0b3JhZ2VSZXF1ZXN0EhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3MSEAoDa2V5GAIgASgJUgNrZXk6COigHwCIoB8A');
...
final $typed_data.Uint8List queryCodeRequestDescriptor = $convert.base64Decode('ChBRdWVyeUNvZGVSZXF1ZXN0EhgKB2FkZHJlc3MYASABKAlSB2FkZHJlc3M6COigHwCIoB8A');
...
final $typed_data.Uint8List queryTxLogsRequestDescriptor = $convert.base64Decode('ChJRdWVyeVR4TG9nc1JlcXVlc3QSEgoEaGFzaBgBIAEoCVIEaGFzaBJGCgpwYWdpbmF0aW9uGAIgASgLMiYuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVxdWVzdFIKcGFnaW5hdGlvbjoI6KAfAIigHwA=');
...
final $typed_data.Uint8List queryTraceTxRequestDescriptor = $convert.base64Decode('');
