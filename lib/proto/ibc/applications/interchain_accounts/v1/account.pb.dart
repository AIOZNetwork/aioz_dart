...
class InterchainAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterchainAccount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ibc.applications.interchain_accounts.v1'), createEmptyInstance: create)
    ...
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountOwner')
  ...
  'Will be removed in next major version')
  InterchainAccount copyWith(void Function(InterchainAccount) updates) => super.copyWith((message) => updates(message as InterchainAccount)) as InterchainAccount; // ignore: deprecated_member_use
