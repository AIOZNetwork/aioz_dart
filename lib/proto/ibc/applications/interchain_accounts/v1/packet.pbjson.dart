...
final $typed_data.Uint8List typeDescriptor = $convert.base64Decode('CgRUeXBlEiUKEFRZUEVfVU5TUEVDSUZJRUQQABoPip0gC1VOU1BFQ0lGSUVEEiMKD1RZUEVfRVhFQ1VURV9UWBABGg6KnSAKRVhFQ1VURV9UWBoEiKMeAA==');
...
const InterchainAccountPacketData$json = const {
  ...
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.ibc.applications.interchain_accounts.v1.Type', '10': 'type'},
...
final $typed_data.Uint8List interchainAccountPacketDataDescriptor = $convert.base64Decode('ChtJbnRlcmNoYWluQWNjb3VudFBhY2tldERhdGESQQoEdHlwZRgBIAEoDjItLmliYy5hcHBsaWNhdGlvbnMuaW50ZXJjaGFpbl9hY2NvdW50cy52MS5UeXBlUgR0eXBlEhIKBGRhdGEYAiABKAxSBGRhdGESEgoEbWVtbxgDIAEoCVIEbWVtbw==');
...
final $typed_data.Uint8List cosmosTxDescriptor = $convert.base64Decode('CghDb3Ntb3NUeBIwCghtZXNzYWdlcxgBIAMoCzIULmdvb2dsZS5wcm90b2J1Zi5BbnlSCG1lc3NhZ2Vz');
