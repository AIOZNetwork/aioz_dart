...
import 'staking.pb.dart' as $4;
import '../../../cosmos/staking/v1beta1/staking.pb.dart' as $5;

class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenesisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.staking.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<$5.Validator>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validators', $pb.PbFieldType.PM, subBuilder: $5.Validator.create)
    ..pc<$5.Delegation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'delegations', $pb.PbFieldType.PM, subBuilder: $5.Delegation.create)
    ..pc<$5.UnbondingDelegation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unbondingDelegations', $pb.PbFieldType.PM, subBuilder: $5.UnbondingDelegation.create)
    ..pc<$5.Redelegation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'redelegations', $pb.PbFieldType.PM, subBuilder: $5.Redelegation.create)
  ...
  factory GenesisState({
    ...
    $core.Iterable<$5.Validator>? validators,
    $core.Iterable<$5.Delegation>? delegations,
    $core.Iterable<$5.UnbondingDelegation>? unbondingDelegations,
    $core.Iterable<$5.Redelegation>? redelegations,
    $core.bool? exported,
  }) {
  ...
  @$pb.TagNumber(4)
  $core.List<$5.Validator> get validators => $_getList(3);

  @$pb.TagNumber(5)
  $core.List<$5.Delegation> get delegations => $_getList(4);

  @$pb.TagNumber(6)
  $core.List<$5.UnbondingDelegation> get unbondingDelegations => $_getList(5);

  @$pb.TagNumber(7)
  $core.List<$5.Redelegation> get redelegations => $_getList(6);
...
class LastValidatorPower extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LastValidatorPower', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.staking.v1beta1'), createEmptyInstance: create)
