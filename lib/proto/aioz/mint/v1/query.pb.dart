...
class QueryParamsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryParamsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
...
class QueryParamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryParamsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
...
class QueryInflationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryInflationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class QueryInflationResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryInflationResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
...
class QueryAnnualInflationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAnnualInflationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  QueryAnnualInflationRequest._() : super();
  factory QueryAnnualInflationRequest() => create();
  factory QueryAnnualInflationRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryAnnualInflationRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryAnnualInflationRequest clone() => QueryAnnualInflationRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryAnnualInflationRequest copyWith(void Function(QueryAnnualInflationRequest) updates) => super.copyWith((message) => updates(message as QueryAnnualInflationRequest)) as QueryAnnualInflationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryAnnualInflationRequest create() => QueryAnnualInflationRequest._();
  QueryAnnualInflationRequest createEmptyInstance() => create();
  static $pb.PbList<QueryAnnualInflationRequest> createRepeated() => $pb.PbList<QueryAnnualInflationRequest>();
  @$core.pragma('dart2js:noInline')
  static QueryAnnualInflationRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryAnnualInflationRequest>(create);
  static QueryAnnualInflationRequest? _defaultInstance;
}

class QueryAnnualInflationResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAnnualInflationResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annualInflation', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;

  QueryAnnualInflationResponse._() : super();
  factory QueryAnnualInflationResponse({
    $core.List<$core.int>? annualInflation,
  }) {
    final _result = create();
    if (annualInflation != null) {
      _result.annualInflation = annualInflation;
    }
    return _result;
  }
  factory QueryAnnualInflationResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory QueryAnnualInflationResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  QueryAnnualInflationResponse clone() => QueryAnnualInflationResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  QueryAnnualInflationResponse copyWith(void Function(QueryAnnualInflationResponse) updates) => super.copyWith((message) => updates(message as QueryAnnualInflationResponse)) as QueryAnnualInflationResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static QueryAnnualInflationResponse create() => QueryAnnualInflationResponse._();
  QueryAnnualInflationResponse createEmptyInstance() => create();
  static $pb.PbList<QueryAnnualInflationResponse> createRepeated() => $pb.PbList<QueryAnnualInflationResponse>();
  @$core.pragma('dart2js:noInline')
  static QueryAnnualInflationResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<QueryAnnualInflationResponse>(create);
  static QueryAnnualInflationResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.List<$core.int> get annualInflation => $_getN(0);
  @$pb.TagNumber(1)
  set annualInflation($core.List<$core.int> v) { $_setBytes(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasAnnualInflation() => $_has(0);
  @$pb.TagNumber(1)
  void clearAnnualInflation() => clearField(1);
}

class QueryAnnualProvisionsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAnnualProvisionsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class QueryAnnualProvisionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryAnnualProvisionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'aioz.mint.v1'), createEmptyInstance: create)
