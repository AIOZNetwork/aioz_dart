...
class Sodium {
  ...
  static Uint8List cryptoAuth(Uint8List i, Uint8List k) {
    ...
    try {
      _cryptoAuth
          .crypto_auth(_out as Pointer<Uint8>, _in, i.length, _k)
  ...
  static Uint8List cryptoAuthKeygen() {
    ...
    try {
      _cryptoAuth.crypto_auth_keygen(_k as Pointer<Uint8>);
    ...
    try {
      _cryptoBox
          .crypto_box_seed_keypair(
              _pk as Pointer<Uint8>, _sk as Pointer<Uint8>, _seed)
  ...
  static KeyPair cryptoBoxKeypair() {
    ...
    try {
      _cryptoBox
          .crypto_box_keypair(_pk as Pointer<Uint8>, _sk as Pointer<Uint8>)
          .mustSucceed('crypto_box_keypair');
      return KeyPair(
          pk: _pk.toList(cryptoBoxPublickeybytes),
          sk: _sk.toList(cryptoBoxSecretkeybytes));
    } finally {
  ...
  static Uint8List cryptoBoxEasy(
    ...
    try {
      _cryptoBox
          .crypto_box_easy(_c as Pointer<Uint8>, _m, m.length, _n, _pk, _sk)
    ...
    try {
      _cryptoBox
          .crypto_box_open_easy(
              _m as Pointer<Uint8>, _c, c.length, _n, _pk, _sk)
  ...
  static DetachedCipher cryptoBoxDetached(
    ...
    try {
      _cryptoBox
          .crypto_box_detached(_c as Pointer<Uint8>, _mac as Pointer<Uint8>, _m,
              m.length, _n, _pk, _sk)
    ...
    try {
      _cryptoBox
          .crypto_box_open_detached(
              _m as Pointer<Uint8>, _c, _mac, c.length, _n, _pk, _sk)
  ...
  static Uint8List cryptoBoxBeforenm(Uint8List pk, Uint8List sk) {
    ...
    try {
      _cryptoBox
          .crypto_box_beforenm(_k as Pointer<Uint8>, _pk, _sk)
  ...
  static Uint8List cryptoBoxEasyAfternm(Uint8List m, Uint8List n, Uint8List k) {
    ...
    try {
      _cryptoBox
          .crypto_box_easy_afternm(_c as Pointer<Uint8>, _m, m.length, _n, _k)
    ...
    try {
      _cryptoBox
          .crypto_box_open_easy_afternm(
              _m as Pointer<Uint8>, _c, c.length, _n, _k)
  ...
  static DetachedCipher cryptoBoxDetachedAfternm(
    ...
    try {
      _cryptoBox
          .crypto_box_detached_afternm(_c as Pointer<Uint8>,
              _mac as Pointer<Uint8>, _m, m.length, _n, _k)
    ...
    try {
      _cryptoBox
          .crypto_box_open_detached_afternm(
              _m as Pointer<Uint8>, _c, _mac, c.length, _n, _k)
  ...
  static Uint8List cryptoBoxSeal(Uint8List m, Uint8List pk) {
    ...
    try {
      _cryptoBox
          .crypto_box_seal(_c as Pointer<Uint8>, _m, m.length, _pk)
  ...
  static Uint8List cryptoBoxSealOpen(Uint8List c, Uint8List pk, Uint8List sk) {
    ...
    try {
      _cryptoBox
          .crypto_box_seal_open(_m as Pointer<Uint8>, _c, c.length, _pk, _sk)
  ...
  static Uint8List cryptoCoreHchacha20(Uint8List i, Uint8List k, Uint8List? c) {
    ...
    try {
      _cryptoCore
          .crypto_core_hchacha20(_out as Pointer<Uint8>, _in, _k, _c)
  ...
  static Uint8List cryptoCoreHsalsa20(Uint8List i, Uint8List k, Uint8List? c) {
    ...
    try {
      _cryptoCore
          .crypto_core_hsalsa20(_out as Pointer<Uint8>, _in, _k, _c)
  ...
  static Uint8List cryptoGenerichash(int outlen, Uint8List i, Uint8List? key) {
    ...
    try {
      _cryptoGenerichash
          .crypto_generichash(_out as Pointer<Uint8>, outlen, _in, i.length,
              _key, key?.length ?? 0)
    ...
    try {
      _cryptoGenerichash
          .crypto_generichash_init(
              _state as Pointer<Uint8>, _key, key?.length ?? 0, outlen)
  ...
  static Uint8List cryptoGenerichashFinal(Pointer<Uint8> state, int outlen) {
    ...
    try {
      _cryptoGenerichash
          .crypto_generichash_final(state, _out as Pointer<Uint8>, outlen)
  ...
  static Uint8List cryptoGenerichashKeygen() {
    ...
    try {
      _cryptoGenerichash.crypto_generichash_keygen(_k as Pointer<Uint8>);
  ...
  static Uint8List cryptoHash(Uint8List i) {
    ...
    try {
      _cryptoHash
          .hash(_out as Pointer<Uint8>, _i, i.length)
          .mustSucceed('crypto_hash');
    ...
    try {
      _cryptoKdf
          .crypto_kdf_derive_from_key(
              _subkey as Pointer<Uint8>, subkeyLen, subkeyId, _ctx, _key)
  ...
  static Uint8List cryptoKdfKeygen() {
    ...
    try {
      _cryptoKdf.crypto_kdf_keygen(_k as Pointer<Uint8>);
  ...
  static KeyPair cryptoKxKeypair() {
    ...
    try {
      _cryptoKx
          .crypto_kx_keypair(_pk as Pointer<Uint8>, _sk as Pointer<Uint8>)
          .mustSucceed('crypto_kx_keypair');
      return KeyPair(
          pk: _pk.toList(cryptoKxPublickeybytes),
          sk: _sk.toList(cryptoKxSecretkeybytes));
    } finally {
  ...
  static SessionKeys cryptoKxClientSessionKeys(
    ...
    try {
      _cryptoKx
          .crypto_kx_client_session_keys(_rx as Pointer<Uint8>,
              _tx as Pointer<Uint8>, _clientPk, _clientSk, _serverPk)
  ...
  static SessionKeys cryptoKxServerSessionKeys(
    ...
    try {
      _cryptoKx
          .crypto_kx_server_session_keys(_rx as Pointer<Uint8>,
              _tx as Pointer<Uint8>, _serverPk, _serverSk, _clientPk)
  ...
  static Uint8List cryptoOnetimeauth(Uint8List i, Uint8List k) {
    ...
    try {
      _cryptoOnetimeauth
          .crypto_onetimeauth(_out as Pointer<Uint8>, _in, i.length, _k)
  ...
  static Pointer<Uint8> cryptoOnetimeauthInit(Uint8List key) {
    ...
    try {
      _cryptoOnetimeauth
          .crypto_onetimeauth_init(_state as Pointer<Uint8>, _k)
  ...
  static Uint8List cryptoOnetimeauthFinal(Pointer<Uint8> state) {
    final _out = calloc<Uint8>(cryptoOnetimeauthBytes);
    try {
      _cryptoOnetimeauth.crypto_onetimeauth_final(
          state, _out as Pointer<Uint8>);
      return _out.toList(cryptoOnetimeauthBytes);
    } finally {
      calloc.free(_out);
    }
  ...
  static Uint8List cryptoOnetimeauthKeygen() {
    ...
    try {
      _cryptoOnetimeauth.crypto_onetimeauth_keygen(_k as Pointer<Uint8>);
  ...
  static Uint8List cryptoPwhash(int outlen, Uint8List passwd, Uint8List salt,
    ...
    try {
      _cryptoPwhash
          .crypto_pwhash(_out as Pointer<Uint8>, outlen, _passwd, passwd.length,
              _salt, opslimit, memlimit, alg)
  ...
  static Uint8List cryptoPwhashStr(
    ...
    try {
      _cryptoPwhash
          .crypto_pwhash_str(_out as Pointer<Uint8>, _passwd, passwd.length,
              opslimit, memlimit)
  ...
  static Uint8List cryptoPwhashStrAlg(
    ...
    try {
      _cryptoPwhash
          .crypto_pwhash_str_alg(_out as Pointer<Uint8>, _passwd, passwd.length,
  ...
  static Uint8List cryptoScalarmultBase(Uint8List n) {
    ...
    try {
      _cryptoScalarmult
          .crypto_scalarmult_base(_q as Pointer<Uint8>, _n)
  ...
  static Uint8List cryptoScalarmult(Uint8List n, Uint8List p) {
    ...
    try {
      _cryptoScalarmult
          .crypto_scalarmult(_q as Pointer<Uint8>, _n, _p)
  ...
  static Uint8List cryptoSecretboxEasy(Uint8List m, Uint8List n, Uint8List k) {
    ...
    try {
      _cryptoSecretbox
          .crypto_secretbox_easy(_c as Pointer<Uint8>, _m, m.length, _n, _k)
  ...
  static DetachedCipher cryptoSecretboxDetached(
    ...
    try {
      _cryptoSecretbox
          .crypto_secretbox_detached(_c as Pointer<Uint8>,
              _mac as Pointer<Uint8>, _m, m.length, _n, _k)
  ...
  static Uint8List cryptoSecretboxKeygen() {
    ...
    try {
      _cryptoSecretbox.crypto_secretbox_keygen(_k as Pointer<Uint8>);
  ...
  static Uint8List cryptoSecretstreamXchacha20poly1305Keygen() {
    ...
    try {
      _cryptoSecretStream
          .crypto_secretstream_xchacha20poly1305_keygen(_k as Pointer<Uint8>);
    ...
    try {
      _cryptoSecretStream
          .crypto_secretstream_xchacha20poly1305_init_push(
              _state as Pointer<Uint8>, _header as Pointer<Uint8>, _k)
    ...
    try {
      _cryptoSecretStream
          .crypto_secretstream_xchacha20poly1305_init_pull(
              _state as Pointer<Uint8>, _header, _k)
    ...
    try {
      _cryptoSecretStream
          .crypto_secretstream_xchacha20poly1305_pull(
            state,
            _m as Pointer<Uint8>,
            _mlenP as Pointer<Uint64>,
            _tagP as Pointer<Uint8>,
            _c,
            c.length,
            _ad,
            _adlen,
  ...
  static Uint8List cryptoShorthash(Uint8List i, Uint8List k) {
    ...
    try {
      _cryptoShorthash
          .crypto_shorthash(_out as Pointer<Uint8>, _in, i.length, _k)
  ...
  static Uint8List cryptoShorthashKeygen() {
    ...
    try {
      _cryptoShorthash.crypto_shorthash_keygen(_k as Pointer<Uint8>);
  ...
  static KeyPair cryptoSignKeypair() {
    ...
    try {
      _cryptoSign
          .crypto_sign_keypair(_pk as Pointer<Uint8>, _sk as Pointer<Uint8>)
  ...
  static Uint8List cryptoSign(Uint8List m, Uint8List sk) {
    ...
    try {
      _cryptoSign
          .crypto_sign(_sm as Pointer<Uint8>, _smlenP as Pointer<Uint64>, _m,
              m.length, _sk)
  ...
  static Uint8List cryptoSignOpen(Uint8List sm, Uint8List pk) {
    ...
    try {
      _cryptoSign
          .crypto_sign_open(_m as Pointer<Uint8>, _mlenP as Pointer<Uint64>,
              _sm, sm.length, _pk)
  ...
  static Uint8List cryptoSignDetached(Uint8List m, Uint8List sk) {
    ...
    try {
      _cryptoSign
          .crypto_sign_detached(_sig as Pointer<Uint8>,
              _siglenP as Pointer<Uint64>, _m, m.length, _sk)
  ...
  static Pointer<Uint8> cryptoSignInit() {
    ...
    _cryptoSign
        .crypto_sign_init(_state as Pointer<Uint8>)
        .mustSucceed('crypto_sign_init');
    return _state;
  }
    ...
    try {
      _cryptoSign
          .crypto_sign_final_create(
              state, _sig as Pointer<Uint8>, _siglenP as Pointer<Uint64>, _sk)
  ...
  static Uint8List cryptoSignEd25519SkToSeed(Uint8List sk) {
    ...
    try {
      _cryptoSign
          .crypto_sign_ed25519_sk_to_seed(_seed as Pointer<Uint8>, _sk)
  ...
  static Uint8List cryptoSignEd25519SkToPk(Uint8List sk) {
    ...
    try {
      _cryptoSign
          .crypto_sign_ed25519_sk_to_pk(_pk as Pointer<Uint8>, _sk)
    ...
    try {
      _cryptoSign
          .crypto_sign_ed25519_pk_to_curve25519(
              _curve25519Pk as Pointer<Uint8>, _ed25519Pk)
    ...
    try {
      _cryptoSign
          .crypto_sign_ed25519_sk_to_curve25519(
              _curve25519Pk as Pointer<Uint8>, _ed25519Sk)
  ...
  static Uint8List cryptoStream(int clen, Uint8List n, Uint8List k) {
    ...
    try {
      _cryptoStream
          .crypto_stream(_c as Pointer<Uint8>, clen, _n, _k)
  ...
  static Uint8List cryptoStreamXor(Uint8List m, Uint8List n, Uint8List k) {
    ...
    try {
      _cryptoStream
          .crypto_stream_xor(_c as Pointer<Uint8>, _m, m.length, _n, _k)
  ...
  static Uint8List cryptoStreamKeygen() {
    ...
    try {
      _cryptoStream.crypto_stream_keygen(_k as Pointer<Uint8>);
  ...
  static Uint8List randombytesBuf(int size) {
    ...
    try {
      _randombytes.randombytes_buf(_buf as Pointer<Uint8>, size);
  ...
  static Uint8List randombytesBufDeterministic(int size, Uint8List seed) {
    ...
    final _seed = seed.toPointer();
    try {
      _randombytes.randombytes_buf_deterministic(
          _buf as Pointer<Uint8>, size, _seed);
      return _buf.toList(size);
    } finally {
      calloc.free(_buf);
      calloc.free(_seed);
  ...
  static void init() {
    if (_sodium.sodium_init() == -1) {
      throw Exception('Libsodium initialization failed');
    }
  }
  ...
  static String bin2hex(Uint8List bin) {
    ...
    try {
      return _sodium
          .sodium_bin2hex(_hex as Pointer<Uint8>, _hexMaxlen, _bin, bin.length)
          .toDartString();
    } finally {
      calloc.free(_hex);
      calloc.free(_bin);
  ...
  static Uint8List hex2bin(String hex, {String? ignore = ': '}) {
    ...
    try {
      _sodium
          .sodium_hex2bin(_bin as Pointer<Uint8>, hex.length, _hex, _hex.length,
              _ignore, _binlen as Pointer<Uint8>, nullptr as Pointer<Uint8>)
  ...
  static String bin2base64(Uint8List bin,
    ...
    try {
      return _sodium
          .sodium_bin2base64(
              _b64 as Pointer<Uint8>, _b64maxlen, _bin, bin.length, variant)
          .toDartString();
    } finally {
      calloc.free(_b64);
      calloc.free(_bin);
  ...
  static Uint8List base642bin(String b64,
    ...
    try {
      _sodium
          .sodium_base642bin(
              _bin as Pointer<Uint8>,
              b64.length,
              _b64,
              _b64.length,
              _ignore,
              _binlen as Pointer<Uint8>,
              nullptr as Pointer<Uint8>,
              variant)
  ...
  static Uint8List pad(Uint8List buf, int blockSize) {
    ...
    try {
      _sodium
          .sodium_pad(_paddedlen as Pointer<Uint32>, _buf, buf.length,
              blockSize, buf.length + blockSize)
  ...
  static Uint8List unpad(Uint8List buf, int blockSize) {
    ...
    try {
      _sodium
          .sodium_unpad(
              _unpaddedlen as Pointer<Uint32>, _buf, buf.length, blockSize)
...
class _CryptoAead {
  ...
  Uint8List encrypt(Uint8List m, Uint8List? ad, Uint8List? nsec, Uint8List npub,
    ...
    try {
      _bindings
          .encrypt(_c as Pointer<Uint8>, _clenP as Pointer<Uint64>, _m,
              m.length, _ad, _adlen, nullptr as Pointer<Uint8>, _npub, _k)
  ...
  Uint8List decrypt(Uint8List? nsec, Uint8List c, Uint8List? ad, Uint8List npub,
    ...
    try {
      _bindings
          .decrypt(_m as Pointer<Uint8>, _mlenP as Pointer<Uint64>,
              nullptr as Pointer<Uint8>, _c, c.length, _ad, _adlen, _npub, _k)
  ...
  DetachedCipher encryptDetached(Uint8List m, Uint8List? ad, Uint8List? nsec,
    ...
    try {
      _bindings
          .encrypt_detached(
              _c as Pointer<Uint8>,
              _mac as Pointer<Uint8>,
              _maclenP as Pointer<Uint64>,
              _m,
              m.length,
              _ad,
              _adlen,
  ...
  Uint8List decryptDetached(Uint8List? nsec, Uint8List c, Uint8List mac,
    ...
    try {
      _bindings
          .decrypt_detached(_m as Pointer<Uint8>, nullptr as Pointer<Uint8>, _c,
              c.length, _mac, _ad, _adlen, _npub, _k)
  ...
  Uint8List keygen() {
    ...
    try {
      _bindings.keygen(_k as Pointer<Uint8>);
